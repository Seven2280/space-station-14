...
ent-VendingMachineMedical = InterDyne Solutions
...
ent-VendingMachineSec = GORLEX Breacher
    .desc = Торговый автомат с экпипировкой Gorlex Securities. На табличке написано "ТОЛЬКО ДЛЯ РАБОТНИКОВ КОРПОРАЦИИ GORLEX SECURITIES LLC".
...
ent-VendingMachineWallmount = торговый автомат
    .desc = { ent-VendingMachine.desc }
ent-VendingMachineWallMedical = Interdyne Mini
